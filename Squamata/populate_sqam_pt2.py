...
# this function continues to populate the database
...
# this creates the MitoGene_Location and Species_Info tables
	c.execute(
...
# this populates those two tables using the information from mitogene_location.csv and species_info.csv
